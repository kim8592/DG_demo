  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 pb-12 font-sans text-left flex flex-col w-full">
      ...
      <main className="w-full px-4 md:px-8 flex-1">
        ...
        ) : <div className="py-32 text-center bg-white rounded-3xl border-4 border-dashed border-slate-300 font-black text-slate-300 uppercase tracking-[0.2em] text-xl">Chọn đ�� dữ liệu để bắt đầu</div>}
      </main>
